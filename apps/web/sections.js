export const sections = [
  {
    ...
    gateQuestion: {
      ...
      helpText: "Have you received an IRP5 / IT3(a) tax certificate for this income / payment from your employer or fund? If not, click here for more information. Please look at your IRP5 / IT3(a) for the 2026 tax year. Please complete the upcoming questions using one IRP5 / IT3(a) at a time. Do NOT add amounts from different IRP5s / IT3(a)s together."
    },
    allowMultiple: true,
    ...
    fields: [
      ...
      { id: "income_codes", type: "codes", text: "Please enter your income amounts, along with their source codes. On your IRP5 / IT3(a), these may be listed under a section called Income Received or Income Sources. Incomes have a source code that starts with a 3. Don't enter source code 3696, 3699 yet - they get asked next.", sourceCodes: ["3601","3602","3603","3604","3605"], helpText: "Available codes: 3601 Income or salary, 3602 Non-taxable income, 3603 Pension (PAYE), 3604 Pension (Excl), 3605 Annual payment", placeholder: "e.g. 708333 3601" },
      ...
      { id: "deduction_codes", type: "codes", text: "On your IRP5 / IT3(a), under Deductions / Contributions, do you have any amounts there? These deductions have source codes that typically start with a 4. Do NOT enter amounts for source codes 4102, 4141, 4142, 4149 & 4116 here. Please enter all these amounts along with their source codes here. ONLY enter source codes beginning with 4. Ignore the total amount next to 4497.", sourceCodes: ["4001","4003","4005","4006","4473","4474","4475"], helpText: "Available codes: 4001 Pension fund, 4003 Provident fund, 4005 Medical aid, 4006 Retirement annuity fund, 4473 Provident fund contribution, 4474 Pension fund contribution, 4475 RAF contribution" },
      { id: "paye_amount", type: "currency", text: "Please enter your PAYE (Pay-as-you-earn): source code 4102. PAYE is also known as Employees Tax. On your IRP5 / IT3(a), it reflects under a section called Tax Paid.", sourceCodes: ["4102"] },
      ...
      { id: "medical_tax_credit", type: "currency", text: "Please enter your Medical Scheme Tax credit, as reflected on your IRP5. This would be next to source code 4116. Do NOT enter amounts from your medical aid tax certificate, this must be completed under the medical section.", sourceCodes: ["4116"] },
      ...
      { id: "directive_number", type: "text", text: "You may see a block at the bottom right or left of your IRP5 / IT3(a) saying Directive Number. Is there a directive number? Please complete the tax directive numbers one at a time for the applicable IRP5 tax certificate.", helpText: "If there is a directive number, please enter it." }
    ]
  },
  {
  ...
  },
  {
    ...
    gateQuestion: {
      ...
      helpText: "This includes payments to a medical aid or hospital plan, as well as other Qualifying Medical Expenses paid by yourself for you or an immediate family member. It does not include medical insurance e.g. Gap cover. Do any of these expenses relate to a physical impairment or disability as approved by SARS? The next set of questions relate to medical aid contributions. A hospital plan is treated as a medical aid for SARS purposes. GAP cover and Medical Insurance are not allowed to be claimed."
    },
    allowMultiple: true,
    ...
    fields: [
      ...
      { id: "medical_contributions", type: "currency", text: "Have a look at the Tax Certificate your medical scheme sent you. Do you see an amount for Contributions? If there is no amount on your Medical Aid Certificate for contributions, have a look at your IRP5 for amounts next to source code 4005. Enter that amount now.", sourceCodes: ["4005","4116"], helpText: "Enter the total amount you paid for the tax year (total contributions)." },
      { id: "medical_uncovered_claims", type: "currency", text: "Have a look at your Medical Aid Certificate, did you have any claims which your Medical Aid would not cover, but you paid for yourself?" }
    ]
  },
  {
    ...
    gateQuestion: {
      ...
      helpText: "Not sure? If your IRP5 shows source code 4006, click Yes. You will now be asked to enter your total contributions (money paid) for the tax year, for one Retirement Annuity Fund (RAF) at a time. You will find this amount on the IT3(f) Tax Certificate received from your fund. You need to request a tax certificate from your fund if you have not received one."
    },
    allowMultiple: true,
  ...
  },
  {
    ...
    gateQuestion: {
      ...
      text: "Are you the director of a Private Company or a member of a Close Corporation? These are entities registered with CIPC. Are you self-employed, freelancing, a sole-proprietor or do you earn money as an Independent Contractor or earn foreign income?"
    },
    allowMultiple: false,
    fields: [
  ...
  },
  {
    ...
    gateQuestion: {
      id: "has_tfsa",
      text: "Did you pay into Tax Free Savings Account during the 2026 tax year?",
      helpText: "A Tax Free Savings Account is not a Retirement Annuity. It is also not a normal bank savings account or a money market account. You must be in possession of an IT3(s) to complete this section. Please look at your IT3(s) for the 2026 tax year. If you have more than one account, please complete the upcoming questions using one IT3(s) at a time - do NOT add amounts from different IT3(s) certificates together."
    },
    allowMultiple: true,
    multipleLabel: "IT3(s)",
    fields: [
      ...
      { id: "tfsa_profit_loss", type: "select", text: "Did the investment make a profit or loss? You will find this on the investment certificate you received. Some certificates do not have this so you can then click NEITHER.", options: [
      ...
      { id: "tfsa_add_another", type: "yesno", text: "Do you want to enter information for a second IT3(s) certificate from a different bank or financial institution?" }
    ]
  },
  {
    ...
    gateQuestion: {
      ...
      text: "Would you like personalised financial tips from TaxTim to help you achieve your financial goals? This has nothing to do with your tax return - it's completely optional.",
      helpText: "Great! I will ask you seven very quick questions:"
    },
    allowMultiple: false,
    fields: [
      { id: "fw_own_home", type: "yesno", text: "Q1 of 7: Do you own the home that you live in?" },
      { id: "fw_car_insured", type: "yesno", text: "Q2 of 7: Is the car you drive insured against theft or accidents?" },
      { id: "fw_saving_money", type: "yesno", text: "Q3 of 7: Are you saving money each month for emergencies, or towards any goals, like education, a holiday, a car or home?" },
      { id: "fw_investing", type: "yesno", text: "Q4 of 7: Are you investing your money efficiently to grow over time?" },
      { id: "fw_life_cover", type: "yesno", text: "Q5 of 7: Do you have life cover in case you can't work, get sick / injured, or (worst case) die?" },
      { id: "fw_big_debts", type: "yesno", text: "Q6 of 7: Do you have any big debts that you need to pay off urgently (excluding a home loan)?" },
      { id: "fw_will", type: "yesno", text: "Q7 of 7: Do you have an official Will in place? A Will declares who gets what when you die. Without one, your family might not get all of your assets." }
    ]
  }
];
